...
\begin{parts}
    ...
    \begin{choices}
        \CorrectChoice A tree with $N$ nodes has $N-1$ edges.
        \choice The height of a tree is always positive.
        \CorrectChoice Every node of a tree is either a leaf node or an internal node.
    ...
    \begin{choices}
        \CorrectChoice In a binary tree, every non-root node has exactly one parent.
        \CorrectChoice Every full binary tree is also a complete binary tree.
        \choice A full binary tree with $n$ non-leaf nodes contains $2n - 1$ total nodes.
        \CorrectChoice A binary tree of height $0$ is also perfect.
    \end{choices}
    ...
    \begin{choices}
        ...
        \CorrectChoice The maximum number of nodes at a given depth of the tree.
    \end{choices}
    ...
    \begin{choices}
        ...
        \CorrectChoice Each node in the tree has exactly one parent pointing to it.
        ...
        \CorrectChoice The root node cannot be the descendent of any nodes.
    \end{choices}
