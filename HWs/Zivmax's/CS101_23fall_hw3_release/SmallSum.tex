...
\begin{parts}
    ...
    \begin{solution}
        ...
        \textbf{Proof:}
            It takes $log_2(n)$ times to split the array into single elements, which means there are $log_2(n)$ times merging.
            And each merging takes $O(n)$ times to merge the array. So the time complexity is $\Theta(nlog(n))$.
    \end{solution}
\end{parts}
