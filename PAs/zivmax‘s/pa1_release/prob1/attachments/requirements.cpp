...
namespace container_checks
{
    ...
    concept InterfacesCorrectOnImpl =
        ...
        requires(ListInstance list, const ListInstance clist, T x, const T cx,
            ...
            {
                clist.begin()
            } -> std::same_as<typename ListInstance::const_iterator>;
            {
                list.cbegin()
            } -> std::same_as<typename ListInstance::const_iterator>;
            {
            ...
            {
                list.insert_after(pos, x)
            } -> std::same_as<void>;
            {
                list.insert_after(pos, cx)
            } -> std::same_as<void>;
            {
                list.insert_after(pos, std::move(x))
            } -> std::same_as<void>;
            {
